...
<div class="px-content">
    ...
    <div class="row">
        <div class="col-sm-12">
        <div class="panel">
            <div id="judul_form" class="panel-title"><h3>Data Produk</h3></div>
                <div class="panel-body">

                   <a class="btn btn-primary" href="{{ url ('tbhproduk') }}"> Tambah Data</a>
                   <br /><br />
                        ...
                        <table id="table-daftar" class="table table-bordered table-condensed table-striped table-hover">
                            ...
                            <tbody >
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="{{ url ('editproduk', $item->id) }}" class="btn btn-warning">Edit</a>
                                </td>
                                <td>
                                  <a href="{{ url ('hapusproduk', $item->id) }}" class="btn btn-warning">Delete</a>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
